...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("Image File Extention")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Select Image File Extention")
                ...
                if path.get()!="":
                    ...
                    if filextention.get()!="Select Image File Extention":
                        if filename.get()!="":
                            ...
                            if filextention.get()=="Adobe Illustrator file" and filename.get()!="":
                                touch.touch(a+"/{}.ai".format(filename.get()))
                            
                            if filextention.get()=="Bitmap image" and filename.get()!="":
                                touch.touch(a+"/{}.bmp".format(filename.get()))
                        

                            if filextention.get()=="GIF image" and filename.get()!="":
                                touch.touch(a+"/{}.gif".format(filename.get()))
                            

                            if filextention.get()=="Icon file" and filename.get()!="":
                                touch.touch(a+"/{}.ico".format(filename.get()))

                            if filextention.get()=="JPEG image" and filename.get()!="":
                                touch.touch(a+"/{}.jpg".format(filename.get()))

                            if filextention.get()=="PNG image" and filename.get()!="":
                                touch.touch(a+"/{}.png".format(filename.get()))
                            
                            if filextention.get()=="PostScript file" and filename.get()!="":
                                touch.touch(a+"/{}.ps".format(filename.get()))

                            if filextention.get()=="PSD image" and filename.get()!="":
                                touch.touch(a+"/{}.psd".format(filename.get()))

                            if filextention.get()=="Scalable Vector Graphics file" and filename.get()!="":
                                touch.touch(a+"/{}.svg".format(filename.get()))

                            if filextention.get()=="TIFF image" and filename.get()!="":
                                touch.touch(a+"/{}.tiff".format(filename.get()))
...
#======================================================================================#
        ...
        fileselect=["Adobe Illustrator file","Bitmap image","GIF image",\
                    "Icon file","JPEG image","PNG image",\
                    "PostScript file","PSD image","Scalable Vector Graphics file","TIFF image"]
        fileselect_combo=Combobox(firstframe,values=fileselect,font=('arial',12),width=25,state="readonly",textvariable=filextention)
        fileselect_combo.set("Select Image File Extention")
